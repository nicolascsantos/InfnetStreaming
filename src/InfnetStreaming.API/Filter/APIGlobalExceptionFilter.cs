...
namespace InfnetStreaming.API.Filter
{
    public class APIGlobalExceptionFilter : IExceptionFilter
    {
        ...
        public void OnException(ExceptionContext context)
        {
            ...
            if (exception is ValidacaoDominioException)
            {
                var ex = exception as ValidacaoDominioException;
            ...
            else if (exception is ProblemaRelacionamentoException)
            {
                var ex = exception as ProblemaRelacionamentoException;
